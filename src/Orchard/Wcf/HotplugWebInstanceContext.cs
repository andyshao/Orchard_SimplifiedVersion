...
namespace HotplugWeb.Wcf {
    public class HotplugWebInstanceContext : IExtension<InstanceContext>, IDisposable {
        private readonly IWorkContextScope _workContextScope;
        private readonly WorkContext _workContext;

        public HotplugWebInstanceContext(IWorkContextAccessor workContextAccessor) {
