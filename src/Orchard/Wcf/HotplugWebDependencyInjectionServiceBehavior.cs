...
namespace HotplugWeb.Wcf {
    public class HotplugWebDependencyInjectionServiceBehavior : IServiceBehavior {
        private readonly IWorkContextAccessor _workContextAccessor;
        private readonly Type _implementationType;
        private readonly IComponentRegistration _componentRegistration;

        public HotplugWebDependencyInjectionServiceBehavior(IWorkContextAccessor workContextAccessor, Type implementationType, IComponentRegistration componentRegistration) {
        ...
        public void ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase) {
            ...
            HotplugWebInstanceProvider provider = new HotplugWebInstanceProvider(this._workContextAccessor, this._componentRegistration);
