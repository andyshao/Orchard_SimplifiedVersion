...
namespace HotplugWeb.Environment {
    ...
    public class DefaultHotplugWebHostContainer : IHotplugWebHostContainer, IDependencyResolver {
        private readonly IContainer _container;


        public DefaultHotplugWebHostContainer(IContainer container) {
        ...
        TService IHotplugWebHostContainer.Resolve<TService>() {
            // 解析服务, or null
