...
namespace HotplugWeb.Logging {
    [Serializable]
    public class HotplugWebLog4netLogger : MarshalByRefObject, Logger, IShim {
        private static readonly Type declaringType = typeof(HotplugWebLog4netLogger);

        private readonly Lazy<ShellSettings> _shellSettings;

        public IHotplugWebHostContainer HostContainer { get; set; }

        public HotplugWebLog4netLogger(log4net.Core.ILogger logger, HotplugWebLog4netFactory factory) {
        ...
        internal HotplugWebLog4netLogger() {
        }

        internal HotplugWebLog4netLogger(ILog log, HotplugWebLog4netFactory factory)
        ...
        private ShellSettings LoadSettings() {
            ...
            var HotplugWebHost = HostContainer.Resolve<IHotplugWebHost>();
            if (HotplugWebHost == null)
                return null;

            var shellContext = HotplugWebHost.GetShellContext(shellSettings);
        ...
        protected internal HotplugWebLog4netFactory Factory { get; set; }
