...
namespace HotplugWeb.Events {
    public class DefaultHotplugWebEventBus : IEventBus {
        ...
        public DefaultHotplugWebEventBus(IIndex<string, IEnumerable<IEventHandler>> eventHandlers, IExceptionPolicy exceptionPolicy) {
